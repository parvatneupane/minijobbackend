...
class VerificationController extends Controller
{
    ...
    {
        $verifications = VerificationModel::with('user')->latest()->get();
    ...
    /**
     * Show single verification by user_id
     */
    public function show($userId)
    {
        ...
        return response()->json([
            ...
            'data' => [
                ...
                'pan_card' => $verification->pan_card
                    ? asset('storage/' . $verification->pan_card)
                    : null,
